//  🏔️ MTECH Code Challenge SB06: "Validating Phone Numbers"
...
//  Instructions:
    ...
    // Write a function that takes in a string and returns an optional formatted phone string, or returns nil if the string that was passed in is not a valid phone number.
...
//  Examples:
    ...
    //  Input: "phone number"
    //  Output: no output produced, nil returned instead
